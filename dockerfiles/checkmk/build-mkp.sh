...
$SU "mkp template kubernetes_namespaces"
...
modify-extension.py "${WORKDIR}" "${CMK}/tmp/check_mk/kubernetes_namespaces.manifest.temp"
...
chmod go+rw "${CMK}/local/lib/python3/cmk_addons/plugins/kubernetes_namespaces/agent_based"
chmod go+rw "${CMK}/local/lib/python3/cmk_addons/plugins/kubernetes_namespaces/checkman"
chmod go+rw "${CMK}/local/lib/python3/cmk_addons/plugins/kubernetes_namespaces/graphing"
chmod go+rw "${CMK}/local/lib/python3/cmk_addons/plugins/kubernetes_namespaces/rulesets"

# Show generated manifest and build the mkp package (runs as cmk user)
cat "${CMK}/tmp/check_mk/kubernetes_namespaces.manifest.temp"
$SU "mkp package ${CMK}/tmp/check_mk/kubernetes_namespaces.manifest.temp"
